...
OBJECTS1 = mainasm.o asm.o stack.o work_with_text.o calculator.o processor.o
OBJECTS2 = mainproc.o calculator.o work_with_text.o bite.o stack.o processor.o
SOURCE_DIR = source/

asm: $(OBJECTS1)
	@echo ---------------------------------------------------------------------------------------------------------------------
	g++ $(FLAGS) $(OBJECTS1) -o asm
	@echo ---------------------------------------------------------------------------------------------------------------------
	./asm
	@echo ---------------------------------------------------------------------------------------------------------------------
