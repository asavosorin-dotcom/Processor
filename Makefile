...
OBJECTS1 = mainasm.o asm.o stack.o work_with_text.o
FILES1 = source/mainasm.cpp source/asm.cpp source/stack.cpp source/work_with_text.cpp
OBJECTS2 = mainproc.o stack.o work_with_text.o bite.o processor.o
...
asm: $(OBJECTS1)
	@echo ---------------------------------------------------------------------------------------------------------------------
	g++ $(FLAGS) $(OBJECTS1) -g -o asm
	@echo ----------------------------------------------------------------------------------------------------------------------------------------------------

proc: $(OBJECTS2)
	@echo ---------------------------------------------------------------------------------------------------------------------
	g++ $(FLAGS) $(OBJECTS2) -o proc
	@echo ---------------------------------------------------------------------------------------------------------------------
	./proc
	@echo ----------------------------------------------------------------------------------------------------------------------
